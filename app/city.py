...
def cities():
    ...
    return render_template('table.html', items = cities, headings = ['City', 'State'], fields = ['name', 'state_id'], edit_url = 'cities_edit', delete_url = 'cities_delete', add_url = 'cities_add', get_url = get_url)
