...
def states():
    ...
    return render_template('table.html', items = states, headings = ['Name', 'Abbreviation'], fields = ['name', 'abbreviation'], edit_url = 'states_edit', delete_url = 'states_delete', add_url = 'states_add', get_url = get_url)
